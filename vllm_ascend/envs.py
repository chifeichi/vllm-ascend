...
env_variables: dict[str, Callable[[], Any]] = {
    ...
    # Log one aggregated Mooncake PD transfer timing record every N completed
    # requests per decode TP worker. 0 disables periodic timing logs. Transfer
    # failures are always printed regardless of this setting. This variable
